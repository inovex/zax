...
import com.inovex.zabbixmobile.billing.util.Base64;
import com.inovex.zabbixmobile.billing.util.Base64DecoderException;
...
public class Security {
    ...
    public static ArrayList<VerifiedPurchase> verifyPurchase(String signedData, String signature) {
        ...
        if (!TextUtils.isEmpty(signature)) {
        	...
        	/**
        	 * create your own class EncodedPublicKey with the static public method #getKey that returns your key as string
        	 */
            String base64EncodedPublicKey = EncodedPublicKey.getKey();
